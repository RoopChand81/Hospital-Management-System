        ...
        <div className="banner">
          <div className="firstBox">
            ...
            <div className="content">
              ...
              <p>
                welcome to the ZeeCare Medical Institute Admin Portal — your 
                central hub to manage doctors, patients, and appointments efficiently
              </p>
            </div>
          </div>
              ...
              {appointments && appointments.length > 0
                ? appointments.map((appointment) => (
                    <tr key={appointment._id}>
                      ...
                      <td><button onClick={()=>handleDeleteStatus(appointment._id)}><MdDeleteOutline className="red" /></button></td>
                    </tr>
                  ))
